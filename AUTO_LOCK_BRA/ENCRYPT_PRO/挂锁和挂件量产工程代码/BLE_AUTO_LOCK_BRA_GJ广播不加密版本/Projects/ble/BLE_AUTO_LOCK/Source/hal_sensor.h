...
//void LCD_P8x16Str(uint8 x, uint8 y,uint8 * Str);

extern const unsigned char Font_Menu_Fir[];
extern const unsigned char Font_Menu_Sec[];
extern const unsigned char Font_Menu_Num[];

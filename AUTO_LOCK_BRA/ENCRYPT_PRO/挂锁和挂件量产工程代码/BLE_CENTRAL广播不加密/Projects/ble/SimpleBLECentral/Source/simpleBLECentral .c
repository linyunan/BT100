...
//           VOID osal_memcpy( request, pEvent->deviceInfo.pEvtData, 14  );
           ...
           {
             if( osal_memcmp(pEvent->deviceInfo.pEvtData, REQSCAN_CMP1, 12)  )
...
/*             
             if( osal_memcmp(pEvent->deviceInfo.pEvtData, REQSCAN_CMP2, 12)  )

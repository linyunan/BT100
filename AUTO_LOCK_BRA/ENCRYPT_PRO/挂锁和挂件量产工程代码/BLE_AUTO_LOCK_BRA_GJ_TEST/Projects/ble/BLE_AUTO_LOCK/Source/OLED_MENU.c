...
//  LCD_P16x16Ch(16,0,21,Font_Menu_Fir);
  ...
  {
    LCD_P8x16Str(0, 0, "Exit MGR Mode    ");
  }
}
...
void OLED_ADDPHONE_MODE(void)   //添加手机用户？
{
  ...
  if( sys_config.ChiOrEng )
  {
    ...
    LCD_P16x16Ch(32,2,80,Font_Menu_Fir);  
    LCD_P16x16Ch(48,2,81,Font_Menu_Fir);
  ...
  {
    LCD_P8x16Str(0, 2, "Add Pendant Usr?");
  }
}
...
void OLED_ADDPHONE_SUCC(uint8 Num)   // 添加了手机用户xx
{
  ...
  if( sys_config.ChiOrEng )
  {
    ...
    LCD_P16x16Ch(48,2,80,Font_Menu_Fir);  
    LCD_P16x16Ch(64,2,81,Font_Menu_Fir);
...
void OLED_DELPHONE_MODE(void)   //删除手机用户？
{
  ...
  {
    LCD_P8x16Str(0, 2, "Era Pendant Usr?");
  }
}

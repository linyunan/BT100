                ...
                if( Button_Num == 0x0B )
                {
                  ...
                  else if(global.MvInPswd[2] == 0x31 && global.MvInPswd[3] == 0x31 && global.MvInPswd[4] == 0x30)
                  {
                    ...
                    */
                    ...
                    while( ((temp2+244)>temp1) || ((temp2>temp1)&&(temp2<(temp1+714))) || ((temp2+244)>0x1FF0) )
                    {
                      temp2 = RandomNumberGenerator();
                    }
  ...
  switch ( newState )
  {
    ...
    case GAPROLE_CONNECTED:
      {    
        ...
        GAPRole_TerminateConnection();
        Clear_Screen(0);
        LCD_P8x16Str(0, 0, "GJ Connected ");
        LCD_P8x16Str(0, 2, "TEST OK !!!! ");
        osal_start_timerEx( bleAutoLock_TaskID, DOOR_POWERONOFF_EVT, 2000 ); 
#if 0        

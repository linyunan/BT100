...
#define HAL_KEY_SW_3_ICTLBIT  BV(2) /* P0IEN - P0.1 enable/disable bit */
...
#define HAL_KEY_SW_7_ICTLBIT  BV(5) /* P0IEN - P0.1 enable/disable bit */
...
#define HAL_KEY_SW_5_ICTLBIT  BV(4) /* P1IEN - P1.6 enable/disable bit */
...
#define HAL_KEY_SW_6_ICTLBIT  BV(5) /* P1IEN - P1.5 enable/disable bit */
...
void HalKeyConfig (bool interruptEnable, halKeyCBack_t cback)
{
  ...
  if (Hal_KeyIntEnable)
  {
    ...
    HAL_KEY_SW_5_PXIFG = ~(HAL_KEY_SW_5_BIT); /* Clear any pending interrupt */
...
HAL_ISR_FUNCTION( halKeyPort1Isr, P1INT_VECTOR )
{
  ...
  if ( (HAL_KEY_SW_5_PXIFG & HAL_KEY_SW_5_BIT) || (HAL_KEY_SW_6_PXIFG & HAL_KEY_SW_6_BIT))
  {
    halProcessKeyInterrupt();
  }

...
{
  HAL_ENTER_ISR();
  if ((HAL_KEY_SW_1_PXIFG & HAL_KEY_SW_1_BIT) || (HAL_KEY_SW_2_PXIFG & HAL_KEY_SW_2_BIT) || (HAL_KEY_SW_3_PXIFG & HAL_KEY_SW_3_BIT) ) //xiaowang
//  if (HAL_KEY_SW_1_PXIFG & HAL_KEY_SW_1_BIT)
 {
...
//   osal_set_event (Hal_TaskID, HAL_KEY_EVENT );
  ...
  */
  ...
  HAL_KEY_SW_1_PXIFG &= ~(BV(4));
  HAL_KEY_SW_2_PXIFG &= ~(BV(6));
  HAL_KEY_SW_3_PXIFG &= ~(BV(7));
  HAL_KEY_CPU_PORT_1_IF = 0;

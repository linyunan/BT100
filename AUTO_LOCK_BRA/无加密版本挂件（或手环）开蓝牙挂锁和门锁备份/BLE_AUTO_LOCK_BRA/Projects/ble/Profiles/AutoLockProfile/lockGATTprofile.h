...
#define DOORPROFILE_CHAR4                   3  // RW uint8 - Profile Characteristic 4 value
#define DOORPROFILE_CHAR5                   4  // RW uint8 - Profile Characteristic 4 value
...
typedef NULL_OK void (*lockProfileChange_t)( uint8 paramID );

typedef struct
{
  lockProfileChange_t        pfnAutoProfileChange;  // Called when characteristic value changes
}lockProfileCBs_t;
 ...
 */
extern bStatus_t AutoProfile_RegisterAppCBs( lockProfileCBs_t *appCallbacks );
